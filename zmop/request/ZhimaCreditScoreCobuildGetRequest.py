...
:author: auto create
:date: 2016-07-08 10:11:48
'''


class ZhimaCreditScoreCobuildGetRequest:
    def __init__(self):
        self.__applyDate = '' # 申请日期。可空
        self.__bizParams = '' # 业务扩展参数。
        self.__mobile = '' # 手机号。可空
    ...
    def setApplyDate(self, applyDate):
        self.__applyDate = applyDate
        self.__apiParas["apply_date"] = applyDate
